...
Supports OpenCart **2.3** & **3.x**, release version (v3.7.0)
...
1. Download the latest release of the plugin [OpenCart 4.x: (v4.2.1)](https://github.com/paytabscom/paytabs-opencart/releases/download/4.2.1/paytabs.ocmod.zip)
...
1. Download the latest release of the plugin [OpenCart 3.x / 2.3 (v3.7.0)](https://github.com/paytabscom/paytabs-opencart/releases/download/3.7.0/paytabs-opencart.ocmod.zip)
2. Go to `"OpenCart admin panel" >> Extensions >> Installer`
3. Click `Upload`
