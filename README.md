...
1. Download the latest release of the plugin [OpenCart 4.x: (v4.3.0)](https://github.com/paytabscom/paytabs-opencart/releases/download/4.3.0/paytabs.ocmod.zip)
