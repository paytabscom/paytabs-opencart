...
1. Download the latest release of the plugin [Click here: 3.2.0](<https://github.com/paytabscom/paytabs-opencart3.x/releases/download/3.2.0/paytabs-opencart.ocmod.zip>)
