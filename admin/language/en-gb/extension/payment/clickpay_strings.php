...
$_['paypal_heading_title']          = 'Clickpay - PayPal';
$_['urpay_heading_title']           = 'Clickpay - UrPay';
// Text
$_['text_extension']                = 'Extensions';
$_['text_success']                  = 'Success: You have modified Clickpay configurations';
$_['text_edit']                     = 'Edit Payment method settings';
$_['text_Clickpayexpress']           = '<a target="_BLANK" href="https://www.Clickpay.com"><img style="width:100px" src="https://www.Clickpay.com/theme/express_checkout/img/checkout.png" alt="Clickpay Express Checkout" title="Clickpay Express Checkout" style="border: 1px solid #EEEEEE;" /></a>';
$_['text_live']                     = 'Live';
