				...
				<form action="<?= $action ?>" method="post" enctype="multipart/form-data" id="form-payment" class="form-horizontal">
					<div class="tab-content">
						...
						<div class="row mb-3 required">
							...
							<div class="col-sm-10">
								<input type="text" name="payment_paytabs_alt_currency" value="<?= $payment_paytabs_alt_currency ?>" placeholder="<?= $entry_alt_currency ?>" id="entry-alt-currency" class="form-control"/>
							</div>
						</div>
