...
class Order extends \Opencart\Admin\Controller\Sale\Order{
    ...
    public function info(): void {
        ...
        $payment_code =  $this->db->query("SELECT payment_method FROM " . DB_PREFIX . "ordertest WHERE order_id = '" . (int)$order_id . "'")->row;
